...
export ZIMAGE_IDENTITY_TRAIN_COMMAND="${ZIMAGE_IDENTITY_TRAIN_COMMAND:-}"
export ZIMAGE_EXPANSION_COMMAND="${ZIMAGE_EXPANSION_COMMAND:-}"
export MODEL_LORA_COMMAND="${MODEL_LORA_COMMAND:-}"
